...
| Was the decision correct under a prespecified criterion? | v0.2.0-rc13 outcome layer | Recomputable linkage, adjudication, denominator, and metric claims that the reference verifier implements | Truth beyond the declared criterion, statistical adequacy beyond the stated design, or legal conclusions |

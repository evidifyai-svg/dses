...
- **v0.2.0-rc13** is the current release candidate for the outcome-evidence
...
- A release candidate is not a permanent release. Implementation reports may
  target it, but must name `0.2.0-rc13` exactly and expect change before 0.2.0.

This repository and `dses.ai` use `0.2.0-rc13` for the current candidate. The
